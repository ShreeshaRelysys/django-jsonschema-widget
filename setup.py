...
def get_version(*file_paths):
    """Retrieves the version from jsonschema_widget/__init__.py"""
...
setup(
    name='django-jsonschema-widget',
    version=version,
    description="""Configuration widget for embedded device.""",
    ...
    license="BSD",
    zip_safe=False,
    keywords='django-jsonschema-widget',
    classifiers=[
